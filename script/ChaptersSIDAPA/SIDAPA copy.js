const scenes = {
    ...
    prologue13: {
        ...
        location: 'Hospital',
        chars: [
            { name: 'Bathala',   img: 'Assets/Characters/Bathala/Bathala_Angry_Mouth.png',   position: 'left',  active: false },
    ...
    FC_a3: {
        ...
        location: 'METRO MANILA',
        chars: [
            { name: 'Libulan', img: 'Assets/Characters/Libulan/Libulan_Neutral.png', position: 'right', active: true },
            { name: 'Sidapa',   img: 'Assets/Characters/Sidapa/Sidapa_Sad.png',   position: 'left',  active: true }
        ],
        speaker: 'Narrator',
